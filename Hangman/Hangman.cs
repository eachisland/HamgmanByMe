...
namespace HangmanGame
{
    class Hangman
    {
        ...
        static string[] wrongGuessesFrames =
      {
            @"      ╔═══╗   " + '\n' +
    @"      |   ║   " + '\n' +
    @"          ║   " + '\n' +
    ...
    @"    ══════╩═══"
        ...
        static string[] deathAnimationsFrames =
        {
            @"      ╔═══╗   " + '\n' +
    @"      |   ║   " + '\n' +
    @"      O   ║   " + '\n' +
    ...
    @" __/══════╩═══"
        ...
        static void DrawCurrentGameState(bool inputIsInvalid, int incorrectGuess, string
                guessedWord, List<char> playerUsedLetters)
        {
            Console.ForegroundColor = ConsoleColor.Green;

            Console.WriteLine("Changed Foreground Color: {0}", Console.ForegroundColor);
